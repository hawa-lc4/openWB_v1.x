...
graphing(){
	...
	tail -1 /var/www/html/openWB/ramdisk/all-live.graph > /var/www/html/openWB/ramdisk/all-live.data4py 2>/dev/null
	chmod 666 /var/www/html/openWB/ramdisk/all-live.data4py
