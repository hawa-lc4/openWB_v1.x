...
response = client.read_holding_registers(address=0x5B00, count=28, slave=ABBid)
...
#Totoal Export
#response = client.read_holding_registers(address=0x5004, count=4, slave=ABBid)
whe = 0.0
...
#Aktueller Verbrauch
#response = client.read_holding_registers(0x5B14,2, slave=ABBid)
...
#KWH Total Import
response = client.read_holding_registers(address=0x5000, count=4, slave=ABBid)
