...
if [[ $sdm120modbusllid1s2 != "254" ]] && [[ $sdm120modbusllid2s2 != "254" ]] && [[ $sdm120modbusllid3s2 != "254" ]] ; then
	n=0
	output=$(sudo /home/pi/openwb1-venv/bin/python /var/www/html/openWB/modules/sdm120modbuslls2/readsdm3.py $sdm120lp3source $sdm120modbusllid1s2 $sdm120modbusllid2s2 $sdm120modbusllid3s2)
	...
	if [[ $sdm120modbusllid2s2 != "254" ]] ; then
		n=0
		output=$(sudo /home/pi/openwb1-venv/bin/python /var/www/html/openWB/modules/sdm120modbuslls2/readsdm3.py $sdm120lp3source $sdm120modbusllid1s2 $sdm120modbusllid2s2)
		while read -r line; do
			if (( $n == 0 )); then
				llv1=$(echo "$line" |  cut -c2- )
				llv1=${llv1%??}
		...
		sudo /home/pi/openwb1-venv/bin/python /var/www/html/openWB/modules/sdm120modbuslls2/readsdm1.py $sdm120lp3source $sdm120modbusllid1s2
	fi
fi
